 ...
 * @return {string}
 */
fun generateKeyBetween(a: String?, b: String?, digits: String = BASE_62_DIGITS): String {
    if (a != null) {
 ...
 * @return {string[]}
 */
fun generateNKeysBetween(a: String?, b: String?, n: Int, digits: String = BASE_62_DIGITS): List<String> {
    if (n == 0) {
        return emptyList()
    }
    if (n == 1) {
        return listOf(generateKeyBetween(a, b, digits))
    }
    if (b == null) {
    ...
    val c = generateKeyBetween(a, b, digits)
    val result = mutableListOf<String>()
    result.addAll(generateNKeysBetween(a, c, mid, digits))
    result.add(c)
